...
//step1:兩個表格聯合查詢，查詢出有排名的gpxfilename（其他是不合格的）；
    ...
    {
        // var result = [];
        var sql ='SELECT distinct gpxfilename from t_race_rank where racename = ?';     
            ...
            else
            {
                ...
                async function read_gpxDatasByFilenames_async(racename,filenames)
                {
                    ...
                    {   
                        ...
                        // var data =  fs.readFile(filename, 'utf8', (err, data) => {
                        //     if (err) {
                        //         // console.error(err);
                        //         return [];
                        //     }
                        ...
                        //         // console.log(decodePath(data));
                        //         var track_data = decodePath(data);
