...
const DBSOURCE = 'db/dbsource/db.sqlite';
  ...
  if (err) {
    ...
    (err) => {
      if (err) {
        ...
        const insert = 'INSERT INTO t_race_gpxfiles (racename, area, gpxfilename,gpxfilepath) VALUES (?,?,?,?)';
    ...
    (err) => {
      if (err) {
        ...
        // Table just created, creating some rows
        const insert = 'INSERT INTO t_race_rank (racename, rank, gpxfilename,arrivingtime) VALUES (?,?,?,?)';
    ...
    (err) => {
      if (err) {
        ...
        const insert = 'INSERT INTO t_race_info (racename, start_lat, start_lon,end_lat,end_lon,starttime) VALUES (?,?,?,?,?,?)';
